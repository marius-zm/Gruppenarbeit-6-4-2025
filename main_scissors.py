...
start_game = ttk.Button(bottom_frame, text="Spiel starten", command=logic_scissors.start_game, style="Custom.TButton")
start_game.grid(row=0, column=3)
